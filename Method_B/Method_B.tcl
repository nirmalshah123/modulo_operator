...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/files/mod.v"]"\
 "[file normalize "$origin_dir/files/constraints.xdc"]"\
 "[file normalize "$origin_dir/files/mod_sims.v"]"\
 "[file normalize "$origin_dir/files/mod_sims_behav.wcfg"]"\
 "[file normalize "$origin_dir/files/mod_sims_func_synth.wcfg"]"\
...
set_property -name "top" -value "mod" -objects $obj
