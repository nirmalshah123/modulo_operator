...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/files/binary_search.v"]"\
 "[file normalize "$origin_dir/files/mac.v"]"\
 "[file normalize "$origin_dir/files/top_level.v"]"\
 "[file normalize "$origin_dir/files/constraints.xdc"]"\
 "[file normalize "$origin_dir/files/TB.v"]"\
 "[file normalize "$origin_dir/files/mod_sims_behav.wcfg"]"\
 "[file normalize "$origin_dir/files/mod.dcp"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "files/constraints.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "files/constraints.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files files/constraints.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files files/constraints.xdc]" -objects $obj
...
set_property -name "top" -value "mod_sims" -objects $obj
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "files/mod.dcp" -objects $obj
