...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/files/synth_1/mod.dcp"]"\
  ]
  foreach ifile $files {
...
# Import local files from the original project
set files [list \
 [file normalize "files/TB.v" ]\
 [file normalize "files/mod_sims_behav.wcfg" ]\
]
